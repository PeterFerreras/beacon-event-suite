...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "G-Visitantes Eventos — Gestión institucional" },
      { name: "description", content: "Sistema institucional para registro de visitantes y asistencia a eventos con protocolo VIP." },
      { property: "og:title", content: "G-Visitantes Eventos" },
      { property: "og:description", content: "Registro de visitantes y asistencia a eventos institucionales." },
